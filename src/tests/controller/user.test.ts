...
describe("User controller", () => {
    ...
    it("getUsers should return status 200 and found users.", async () => {
        ...
        const context = {status: undefined, body: undefined} as BaseContext;
    ...
    it("getUser should return status 200 and single user found by id.", async () => {
        ...
        (getManager as jest.Mock).mockReturnValue({ getRepository: () => userRepository });
        const context = {status: undefined, body: undefined, params: {id: 0} } as unknown as BaseContext;
    ...
    it("createUser should return status 201 if is created.", async () => {
        ...
        const context = {status: undefined, body: undefined, request : {body: user} } as unknown as BaseContext;
    ...
    it("updateUser should return 201 if user is updated.", async () => {
        ...
        (getManager as jest.Mock).mockReturnValue({ getRepository: () => userRepository });
        (validate as jest.Mock).mockReturnValue([]);
        const context = {status: undefined, body: undefined, params: {id : 0}, request : {body: user} } as unknown as BaseContext;
    ...
    it("deleteUser should return status 400 if user does not exists.", async () => {
        ...
        (getManager as jest.Mock).mockReturnValue({ getRepository: () => userRepository });
        const context = {status: undefined, body: undefined, params: {id: 0}, state: {user: user }} as unknown as BaseContext;
    ...
    it("deleteUser should return status 403 if user has no permission.", async () => {
        ...
        (getManager as jest.Mock).mockReturnValue({ getRepository: () => userRepository });
        const context = {status: undefined, body: undefined, params: {id: 0}, state: {user : "johndoe@gmail.com" } as unknown as User } as unknown as BaseContext;
        await UserController.deleteUser(context);
